 ...
 */
class RemindMsgUnreadCommand implements CommandInterface
{
 ...
 * @author shsrain <shsrain@163.com>
 */
class RemindMsgUnreadCommandHandler extends AbstractCommandHandler
{
    ...
    public function remindMsgUnread()
    {
